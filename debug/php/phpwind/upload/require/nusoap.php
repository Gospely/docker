...
//		}
		...
		if (
			...
			$this->setError("Unsupported HTTP response status $http_status $http_reason (newsoapclient->response has contents of the response)");
			return false;
		}
...
* @access   public
*/
class newsoapclient extends nusoap_base  {
	...
	* @access   public
	*/
	function newsoapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class soap_proxy_'.$r.' extends newsoapclient {
	'.$evalStr.'
}';
		return $evalStr;
	}
